...
public class MerchantSystemServiceImpl implements MerchantSystemService {
    @Resource
    private MerchantSysLogMapper merchantSysLogMapper;
    ...
    public void saveSystemLog(SysLog log) {
        log.setId(UUID.createKey("merchant_sys_log"));
        merchantSysLogMapper.insertSelective(log);
    }
    ...
    public PageResult getSystemLog(Page page) {
        ...
        List<SysLog> logs = merchantSysLogMapper.selectBySearchInfo(page.getLogSearch());
