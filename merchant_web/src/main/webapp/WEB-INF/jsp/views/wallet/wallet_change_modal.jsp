...
<div class="modal-header">
    ...
    <h3 class="modal-title" id="modal-title">商户&nbsp;{{order.merId}}&nbsp;余额提现：</h3>
</div>
    ...
    <form name="myForm" class="form-horizontal">
        <div class="ibox-content    ">
            ...
            <div class="form-group">
                <label class="col-sm-3 control-label"><span class="text-danger">*</span>商户：</label>
                <div class="col-sm-9">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" ng-readonly="true" class="form-control"
                           value="{{order.totalAvailableAmount + ' '}}{{maxAmount | number:2}}">
                </div>
            </div>
            <div class="form-group">
