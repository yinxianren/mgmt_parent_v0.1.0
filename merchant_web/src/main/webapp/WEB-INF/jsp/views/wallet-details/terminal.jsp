...
<div class="animated fadeInRight">
    <div class="wrapper wrapper-content ng-scope" ng-controller="terminalMerchantsDetailsCtrl">
        <div class="row">
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>{{'TERMINAL_MERCHANTS_WALLET_DETAILS' | translate}}</h5>
                    </div>
                    <div class="ibox-content">
                        ...
                        <div class="table-responsive">
                            <table ng-table="terminalMerchantsDetailsTable"
                                ...
                                <tr ng-repeat="row in $data">
                                    ...
                                    <td class="text-center" data-title="'类型'">
                                        {{row.type | getValueByList : types : 'firstValue' : 'name'}}
                                    </td>
                        ...
                        <my-pagination table-param="terminalMerchantsDetailsTable"></my-pagination>
                    </div>
                </div>
            </div>
        </div>
