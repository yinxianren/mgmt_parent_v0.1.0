...
<div class="animated fadeInRight">
    <div class="wrapper wrapper-content ng-scope" ng-controller="agentUserMgmtCtrlCtrl">
        <div class="row">
            <div class="col-lg-12">
                            ...
                            <table ng-table="userTable"
                                ...
                                <tr ng-repeat="row in $data">
                                    ...
                                    <td class="text-center" data-title="'创建时间'">
                                        {{row.createTime | date:'yyyy-MM-dd hh:mm:ss sss'}}
                                    </td>
                                    <td class="text-center" data-title="'修改人'">
                                        {{row.modifier}}
                                    </td>
                                    <td class="text-center" data-title="'修改时间'">
                                        {{row.modifyTime | date:'yyyy-MM-dd hh:mm:ss sss'}}
                                    </td>
