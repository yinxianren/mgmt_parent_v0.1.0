...
<div class="animated fadeInRight">
    <div class="wrapper wrapper-content ng-scope" ng-controller="agentMerchantAddCtrl"  >
        <div class="row">
            <div class="col-lg-12">
                <%--新增和修改--%>
                <div class="ibox float-e-margins" ng-show="goType == 0 || goType == 1">
                    <div class="ibox-title">
                        ...
                        <h5 ng-show="goType == 1">{{'商户编辑' | translate}}</h5>
                    </div>
                    <div class="ibox-content">
                        ...
                        <form name="myForm" class="form-horizontal">
                            <div class="form-group"ng-show="{{goType == 0 ?false:true}}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-2">
                                    <input class="form-control b-r-sm"
                                           ...
                                           ng-blur="merIdBlur($event, merchantInfo.parentId)"
                                           readonly
                                           required>
                                </div>
                            </div>
