    ...
    <div class="modal-body" id="modal-body">
        <form name="myForm" class="form-horizontal">
            <div class="ibox-content no-borders tab-content">
                ...
                <div class="form-group  m-t">
                    <label class="col-sm-2 control-label p-w-xs"><span class="text-danger">*</span>单笔交易限额：</label>
                    <div class="col-sm-10">
                        <input class="form-control b-r-sm"
                               name="merId"
                               type="text"
                ...
                <div class="form-group  m-t">
                    <label class="col-sm-2 control-label p-w-xs"><span class="text-danger">*</span>日交易限额：</label>
                    <div class="col-sm-10">
                        <input class="form-control b-r-sm"
                               name="merId"
                               type="text"
                ...
                <div class="form-group  m-t">
                    <label class="col-sm-2 control-label p-w-xs"><span class="text-danger">*</span>月交易限额：</label>
                    <div class="col-sm-10">
                        <input class="form-control b-r-sm"
                               name="merId"
                               type="text"
