                            ...
                            <table ng-table="agentWalletDetailsTable"
                                ...
                                <tr ng-repeat="row in $data">
                                    <td class="text-center" data-title="'代理商'">
                                        ${sessionScope.merchantInfo.agentMerchantId}(${sessionScope.merchantInfo.agentMerchantName})
                                    </td>
                                    ...
                                    <td class="text-center" data-title="'手续费'">
                                        {{row.fee==null?0:row.fee | number: 2}}
                                    </td>
                                    <td class="text-center" data-title="'总余额'">
                                        {{row.totalBenifit==null?0:row.totalBenifit | number: 2}}
                                    </td>
