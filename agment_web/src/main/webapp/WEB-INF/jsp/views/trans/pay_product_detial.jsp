    ...
    <div class="ibox-content sk-loading no-padding no-borders">
        ...
        <div class="table-responsive">
            <table class="table table-condensed table-striped table-hover table-bordered">
                ...
                <tr>
                    <td class="text-center">{{productDetail.productId  }}</td>
                    <td class="text-center">{{productDetail.productName  }}</td>
                    <td class="text-center">{{productDetail.price  }}</td>
                    <td class="text-center">{{productDetail.quantity  }}</td>
                    <td class="text-center">{{productDetail.url  }}</td>
                </tr>
            </table>
        </div>
        <div class="table-responsive" >
            <table class="table table-condensed table-striped table-hover table-bordered">
                ...
                <tr>
                    <td class="text-center">{{productDetail.productDescribe}}</td>
                    <td class="text-center">{{productDetail.productTypeId}}</td>
                </tr>
            </table>
            <table class="table table-condensed table-striped table-hover table-bordered">
                <tr>
                ...
                <tr  >
                    <td class="text-center">{{productDetail.payId}}</td>
                    <td class="text-center">{{productDetail.merOrderId}}</td>
                </tr>
            </table>
        </div>
    </div>
