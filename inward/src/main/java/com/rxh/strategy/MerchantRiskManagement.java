...
public abstract class MerchantRiskManagement implements PayUtil, PayAssert {
    ...
    public void riskManagement(MerchantQuotaRisk merchantQuotaRisk,
        ...
        state( !(trnasOrderAmount.compareTo(singleQuotaAmount)>0),format("【商户风控】商户号：%s,订单号：%s：该商户单笔金额超过单笔最大额度！",merId,merOrderId));
        //获取该商户累计交易额
