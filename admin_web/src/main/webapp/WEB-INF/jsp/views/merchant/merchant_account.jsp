    ...
    <div class="modal-body" id="modal-body">
        <form name="myForm" class="form-horizontal">
            <div class="ibox-content no-borders tab-content">
                ...
                <div class="form-group  m-t">
                    <label class="col-sm-4 control-label p-w-xs"><span class="text-danger">*</span>银行名称：</label>
                    <div class="col-sm-8">
                        <input class="form-control b-r-sm"
                               name="bankName"
                               type="text"
                ...
                <div class="form-group  m-t">
                    <label class="col-sm-4 control-label p-w-xs"><span class="text-danger">*</span>银行卡号：</label>
                    <div class="col-sm-8">
                        <input type="text"
                ...
                <div class="form-group  m-t">
                    <label class="col-sm-4 control-label p-w-xs"><span class="text-danger">*</span>收款银行网点名称：</label>
                    <div class="col-sm-8">
                        <input class="form-control b-r-sm"
                               name="bankBranchName"
                               type="text"
                ...
                <div class="form-group  m-t">
                    <label class="col-sm-4 control-label p-w-xs"><span class="text-danger">*</span>收款行开户行号：</label>
                    <div class="col-sm-8">
                        <input type="text"
                               class="form-control input-sm"
                               name="bankBranchNum"
                ...
                <div class="form-group">
                    <label class="col-sm-4 control-label p-w-xs"><span class="text-danger">*</span>证件类型：</label>
                    <div class="col-sm-8">
                ...
                <div class="form-group  m-t">
                    <label class="col-sm-4 control-label p-w-xs"><span class="text-danger">*</span>证件号码：</label>
                    <div class="col-sm-8">
                        <input type="text"
                               class="form-control input-sm"
                               maxlength="20"
                ...
                <div class="form-group  m-t">
                    <label class="col-sm-4 control-label p-w-xs"><span class="text-danger">*</span>证件：</label>
                    <div class="col-sm-8">
