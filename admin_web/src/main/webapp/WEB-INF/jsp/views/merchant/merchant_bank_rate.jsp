...
<div class="merchant-rate">
    <div class="modal-header"  >
        ...
        <h3 class="modal-title" id="modal-title">商户银行费率配置</h3>
    </div>
            ...
            <div class="ibox-content no-borders tab-content">
                ...
                <table>
                    <tr>
                        ...
                        <th class="text-center rate-tr-width" style="min-width: 150px">银行名称</th>
                        <th class="text-center rate-tr-width" style="min-width: 150px">银行编码</th>
                    ...
                    <tr ng-repeat="row in merchantRates track by $index" class="rate-tr-width">
                        ...
                        <td class="text-center col-lg-2" style="min-width: 100px" >
                            <input type="test"
                                   class="form-control"
                                   name="bankCode{{$index}}"
<%--                                   ng-blur="singleFeeBlur($event, 'bankCode'+$index)"--%>
                                   ng-model="row.bankCode"
                                   required>
                        </td>
