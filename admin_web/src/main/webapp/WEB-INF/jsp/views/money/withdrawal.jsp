            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>{{ 'WITHDRAW_DEPOSIT_INQUIRY' | translate }}</h5>
                    </div>
                    <div class="ibox-content sk-loading " ng-controller="financeDrawingCtrl"  >
                            ...
                            <table ng-table="financeDrawingTable"
                                ...
                                <tr ng-repeat="row in $data">
                                    ...
                                    <%--<td class="text-center" data-title="'操作'">--%>
                                        <%--<span ng-show="row.status==1" ><button--%>
                                                <%--class="btn btn-xs no-margins ng-binding btn-primary active"--%>
                                        <%--ng-click="showChangeModal(row)"--%>
                                        <%-->--%>
                                            <%--解冻--%>
                                        <%--</button></span>--%>
