...
<%--时间控件--%>
<link href="css/wui-date/wui.css" rel="stylesheet">
<link href="css/wui-date/style.css" rel="stylesheet">
...
<body id="page-top" class="fixed-sidebar fixed-nav fixed-nav-basic {{$state.current.data.specialClass}}"
	...
	<%--<script src="js/bootstrap/angular-locale_zh-cn.js"></script>--%>
	<%--<script src="https://cdn.bootcss.com/angular-i18n/1.7.8/angular-locale_zh-cn.js"></script>--%>
	...
	<%--时间控件--%>
	<script src="js/wui-date/wui-date.js"></script>
...
-->
	...
	<script src="js/home/wallet.js"></script>
	<script src="js/home/passageway.js"></script>
	<script src="js/home/agent.js"></script>
	<script src="js/home/trans.js"></script>
	<script src="js/home/order.js"></script>
	<script src="js/home/merchant.js"></script>
	<script src="js/order_track/track.js"></script>
	<script src="js/home/risk.js"></script>
	<script src="js/wallet-details/terminal.js"></script>
	<script src="js/wallet-details/merdetails.js"></script>
