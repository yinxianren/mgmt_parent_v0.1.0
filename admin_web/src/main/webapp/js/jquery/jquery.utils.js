...
jQuery.extend({
  ...
  //选择商户
    selectMerchant: function (opt) {
        ...
        top.selectSuitsOpt = _opt;
        $.jDialog({
            id: "selectMerchantDialog",
            width: "800",
            height: '430',
            url: "/admin/mer/merchantInfo/selectMerchantPay",
            title: "选择商户",
            _ajax: true,
            ...
            actions: [
                {
                    ...
                    actionClasss: 'popbtn popbtn01',
                    action: function (dialogObj) {
                        var data = top.selectMerchantGrid.getCheckBoxValues();
  ...
  //根据查询条件已存在的订单信息选择商户
    selectMerchantByOrderInfo: function (opt) {
        var defaultOpt = {
            success: function (data) {
            },
            ajaxdata: {
        ...
        $.jDialog({
            ...
            width: "800",
            height: '430',
            url: "/admin/core/order/selectMerchantByOrderInfo",
            title: "选择商户",
            _ajax: true,
            _ajaxdata: _opt.ajaxdata,
            needAction: true,
    ...
    //根据查询条件已存在的退款信息选择商户
    selectMerchantByRefundInfo: function (opt) {
        var defaultOpt = {
            success: function (data) {
            },
            ajaxdata: {
        ...
        $.jDialog({
            ...
            width: "800",
            height: '430',
            url: "/admin/core/orderChange/selectMerchantByRefundInfo",
            title: "选择商户",
            _ajax: true,
            _ajaxdata: _opt.ajaxdata,
            needAction: true,
    ...
    //根据查询条件已存在的拒付信息选择商户
    selectMerchantByProtestInfo: function (opt) {
        var defaultOpt = {
            success: function (data) {
            },
            ajaxdata: {
        ...
        $.jDialog({
            ...
            width: "800",
            height: '430',
            url: "/admin/core/orderChange/selectMerchantByProtestInfo",
            title: "选择商户",
            _ajax: true,
            _ajaxdata: _opt.ajaxdata,
            needAction: true,
    ...
    //根据查询条件已存在的商户对账信息选择商户
    selectMerchantByBusinessMerRecon: function (opt) {
        var defaultOpt = {
            success: function (data) {
            },
            ajaxdata: {
        ...
        top.selectSuitsOpt = _opt;
        $.jDialog({
            id: "selectMerchantByBusinessMerReconDialog",
            width: "800",
            height: '430',
            url: "/admin/fms/businessMoney/selectMerchantByBusinessMerRecon",
            title: "选择商户",
            _ajax: true,
            _ajaxdata: _opt.ajaxdata,
            needAction: true,
    ...
    //根据查询条件已存在的商户对账信息选择收单账户
    selectAcquirerAccountsByBusinessMerRecon: function (opt) {
        var defaultOpt = {
            success: function (data) {
            },
            ajaxdata: {
        ...
        top.selectSuitsOpt = _opt;
        $.jDialog({
            id: "selectAcquirerAccountsByBusinessMerReconDialog",
            width: "800",
            height: '430',
            url: "/admin/fms/businessMoney/selectAcquirerAccountsByBusinessMerRecon",
            title: "选择商户",
            _ajax: true,
            _ajaxdata: _opt.ajaxdata,
            needAction: true,
            ...
            actions: [
                {
                    ...
                    actionClasss: 'popbtn popbtn01',
                    action: function (dialogObj) {
                        var data = top.selectAcquirerAccountsGrid.getCheckBoxValues();
                        if ($.isFunction(_opt.success)) {
                            var result = _opt.success(data);
                            if (result == true || result == undefined) {
                                dialogObj.confirm();
    ...
    //根据查询条件已存在的通道对账信息选择通道
    selectMerchantByBusinessChannelRecon: function (opt) {
        var defaultOpt = {
            success: function (data) {
            },
            ajaxdata: {
        ...
        top.selectSuitsOpt = _opt;
        $.jDialog({
            id: "selectMerchantByBusinessChannelReconDialog",
            width: "800",
            height: '430',
            url: "/admin/fms/businessMoney/selectMerchantByBusinessChannelRecon",
            title: "选择商户",
            _ajax: true,
            _ajaxdata: _opt.ajaxdata,
            needAction: true,
    ...
    selectWebSite: function (opt) {
        ...
        top.selectSuitsOpt = _opt;
        $.jDialog({
            id: "selectWebSiteDialog",
            width: "800",
            height: '430',
            url: "/admin/mer/webSite/selectSiteUrl",
            title: "选择域名",
            _ajax: true,
            _ajaxdata: _opt.ajaxdata,
            needAction: true,
            ...
            actions: [
                {
                    ...
                    actionClasss: 'popbtn popbtn01',
                    action: function (dialogObj) {
                        var data = top.selectSiteUrlGrid.getCheckBoxValues();
                        if ($.isFunction(_opt.success)) {
                            var result = _opt.success(data);
                            if (result == true || result == undefined) {
                                dialogObj.confirm();
 ...
 * @returns {Boolean}
 */
function CheckForm(endTime,startTime,message){
	if(startTime==""||endTime==""){
	 ...
	 var oDate1 = new Date(aDate[1] + '-' + aDate[2] + '-' + aDate[0]);  //结束日期
	  var oDate2 = new Date(sDate[1] + '-' + sDate[2] + '-' + sDate[0]);    //开始日期
	  if(oDate1 < oDate2) {
	         alert("结束日期必须大于开始日期!");
	         return false;
	   }else {
