 ...
 * @example
 *
 * ### Credit consumer resource
 *
 * ```js
     // Define CreditCard class
     var CreditCard = $resource('/user/:userId/consumer/:cardId',
     ...
     var cards = CreditCard.query(function() {
       // GET: /user/123/consumer
       // server returns: [ {id:456, number:'1234', name:'Smith'} ];

       var consumer = cards[0];
       // each item is an instance of CreditCard
       expect(consumer instanceof CreditCard).toEqual(true);
       consumer.name = "J. Smith";
       // non GET methods are mapped onto the instances
       consumer.$save();
       // POST: /user/123/consumer/456 {id:456, number:'1234', name:'J. Smith'}
       // server returns: {id:456, number:'1234', name: 'J. Smith'};

       // our custom method is mapped as well.
       consumer.$charge({amount:9.99});
       // POST: /user/123/consumer/456?amount=9.99&charge=true {id:456, number:'1234', name:'J. Smith'}
     });
     ...
     newCard.$save();
     // POST: /user/123/consumer {number:'0123', name:'Mike Smith'}
