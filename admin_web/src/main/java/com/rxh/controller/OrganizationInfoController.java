...
public class OrganizationInfoController {
    ...
    public List<OrganizationInfo> getAllOrganization(@RequestBody OrganizationInfo organizationInfo){
        ...
        for (OrganizationInfo organizationInfo1 : organizationInfos){
...
//        List<OrganizationInfo> infoList = organizationService.getIdsAndName();
     /*   for (OrganizationInfo organizationInfo : infoList){
            ProductSettingTable productSettingTable = new ProductSettingTable();
            ...
            organizationInfo.setProductIds(sj.toString());
            organizationInfo.setProductTypes(productSettingTables);
        }
        init.put( "organizations",infoList);*/
