...
public class SysPrivileges implements Serializable {
    // 权限主键
    private Long id;
    ...
    // 子菜单
    private List<SysPrivileges> submenu;
    ...
    public List<SysPrivileges> getSubmenu() {
        return submenu;
    }

    public void setSubmenu(List<SysPrivileges> submenu) {
