...
public class RiskExtend implements Serializable {
     //
    private Long id;
    ...
    private String element;
     ...
     // maxmind-分数,CyberSource-验证项(以,分隔)
    ...
    /**
     * 0: 通用 1:商户 2:域名
     * @return ref_type 0: 通用 1:商户 2:域名
     */
     ...
     * @return element_value maxmind-分数,CyberSource-验证项(以,分隔)
     ...
     * @param elementValue maxmind-分数,CyberSource-验证项(以,分隔)
