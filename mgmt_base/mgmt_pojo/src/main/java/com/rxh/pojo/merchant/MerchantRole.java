...
public class MerchantRole implements Serializable {
    ...
    // 角色拥有权限
    private List<MerchantPrivileges> privileges;

    public MerchantRole() {
    }

    public MerchantRole(String role) {
        this.role = role;
    }
    ...
    public List<MerchantPrivileges> getPrivileges() {
        return privileges;
    }

    public void setPrivileges(List<MerchantPrivileges> privileges) {
