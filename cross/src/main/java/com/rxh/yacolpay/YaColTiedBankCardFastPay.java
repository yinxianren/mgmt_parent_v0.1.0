...
public class YaColTiedBankCardFastPay extends AbstractYaColIPay{

    private final static Logger logger = LoggerFactory.getLogger(YaColTiedBankCardFastPay.class);
    @Autowired
    private YaColBindingBankCardAdvanceFastPay yaColBindingBankCardAdvanceFastPay;
    @Autowired
